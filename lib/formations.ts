...
export const FORMATIONS: Record<string, FormationSlot[]> = {
  ...
  "4-1-2-1-2": [
    { code: "GK", pos: "GK", x: 50, y: 93 },
    { code: "LB", pos: "LB", x: 14, y: 74 },
    { code: "LCB", pos: "CB", x: 36, y: 77 },
    { code: "RCB", pos: "CB", x: 64, y: 77 },
    { code: "RB", pos: "RB", x: 86, y: 76 },
    { code: "CDM", pos: "CDM", x: 50, y: 61 },
    { code: "LCM", pos: "CM", x: 27, y: 50 },
    { code: "RCM", pos: "CM", x: 73, y: 50 },
    { code: "CAM", pos: "CAM", x: 50, y: 36 },
    { code: "LST", pos: "ST", x: 39, y: 17 },
    { code: "RST", pos: "ST", x: 61, y: 17 },
  ],
  "3-4-3": [
    { code: "GK", pos: "GK", x: 50, y: 93 },
    { code: "LCB", pos: "CB", x: 28, y: 76 },
    { code: "CB", pos: "CB", x: 50, y: 78 },
    { code: "RCB", pos: "CB", x: 72, y: 76 },
    { code: "LWB", pos: "LWB", x: 12, y: 56 },
    { code: "LCM", pos: "CM", x: 37, y: 55 },
    { code: "RCM", pos: "CM", x: 63, y: 55 },
    { code: "RWB", pos: "RWB", x: 88, y: 56 },
    { code: "LW", pos: "LW", x: 22, y: 24 },
    { code: "ST", pos: "ST", x: 50, y: 17 },
    { code: "RW", pos: "RW", x: 78, y: 24 },
  ],
  "5-3-2": [
    { code: "GK", pos: "GK", x: 50, y: 93 },
    { code: "LWB", pos: "LWB", x: 11, y: 68 },
    { code: "LCB", pos: "CB", x: 31, y: 78 },
    { code: "CB", pos: "CB", x: 50, y: 76 },
    { code: "RCB", pos: "CB", x: 69, y: 78 },
    { code: "RWB", pos: "RWB", x: 89, y: 68 },
    { code: "LCM", pos: "CM", x: 30, y: 52 },
    { code: "CM", pos: "CDM", x: 50, y: 56 },
    { code: "RCM", pos: "CM", x: 70, y: 52 },
    { code: "LST", pos: "ST", x: 39, y: 19 },
    { code: "RST", pos: "ST", x: 61, y: 19 },
  ],
  "4-5-1": [
    { code: "GK", pos: "GK", x: 50, y: 93 },
    { code: "LB", pos: "LB", x: 14, y: 74 },
    { code: "LCB", pos: "CB", x: 37, y: 76 },
    { code: "RCB", pos: "CB", x: 63, y: 76 },
    { code: "RB", pos: "RB", x: 86, y: 74 },
    { code: "LM", pos: "LM", x: 12, y: 48 },
    { code: "LCM", pos: "CM", x: 32, y: 55 },
    { code: "CM", pos: "CDM", x: 50, y: 58 },
    { code: "RCM", pos: "CM", x: 68, y: 55 },
    { code: "RM", pos: "RM", x: 88, y: 48 },
    { code: "ST", pos: "ST", x: 50, y: 18 },
  ],
};
